...
Date                               Date`
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-neutral-100">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="bg-gradient-to-br from-slate-700 to-slate-900 p-2 rounded-xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-slate-700 to-slate-900 text-white rounded-lg font-medium text-sm hover:shadow-lg transition-all">
                Upgrade to Pro
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <label className="block">
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-12 text-center hover:border-slate-600 hover:bg-slate-50/50 transition-all cursor-pointer">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <button 
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-slate-700 to-slate-900 text-white rounded-xl font-semibold hover:shadow-lg transition-all"
                  >
                    <Download className="w-5 h-5" />
                    Download Full Report (TXT)
                  </button>
                  <button className="px-6 py-4 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-semibold hover:border-slate-700 hover:text-slate-700 transition-all">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-slate-700 focus:outline-none resize-none"
                    rows="4"
                  />
                </div>
                ...
                <button
                  ...
                  disabled={generating}
                  className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-slate-700 to-slate-900 text-white rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50"
                >
                  {generating ? (
                    <>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex gap-3">
                    <button className="flex items-center gap-2 px-4 py-2 bg-white border-2 border-gray-200 text-gray-700 rounded-lg font-medium hover:border-slate-700 transition-all">
                      <Download className="w-4 h-4" />
                      Export DOCX
                    </button>
                    <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-slate-700 to-slate-900 text-white rounded-lg font-medium hover:shadow-lg transition-all">
                      <Download className="w-4 h-4" />
                      Export PDF
                    </button>
                  </div>
